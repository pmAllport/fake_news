...
class Bi_directional():
    ...
    def train_model(self,weight_matrix,length,train_data,train_values,test_data,test_values):
        ...
        model = tf.keras.Sequential([
            ...
            tf.keras.layers.Bidirectional(LSTM(5, recurrent_dropout=(0.2))),
        ...
        history = model.fit(train_data, train_values, batch_size=11, epochs=14, shuffle = True,validation_data=(test_data, test_values)) 
        
        model.save(str(os.getcwd())+"/"+"models"+'LSTM_Bidirectional.h5', model)
